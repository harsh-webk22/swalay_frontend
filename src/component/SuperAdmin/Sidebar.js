            ...
            <div className="collapse show" id="dashboardsExamples">
              <ul className="nav">
                <li className="nav-item active">
                  <Link className="nav-link text-white active" to="/superAdmin">
            ...
            <div className="collapse" id="ToolsExamples">
              <ul className="nav ">
                <li className="nav-item ">
                  <Link
                    className="nav-link text-white "
                    to="/superAdmin/instagramLinking"
                  >
                    <span className="sidenav-normal  ms-2  ps-1">
                      InstagramLinking
                    </span>
                ...
                <li className="nav-item ">
                  <Link
                    className="nav-link text-white "
                    to="/superAdmin/lyricsSubmission"
                  >
                    <span className="sidenav-normal  ms-2  ps-1">
                      Lyrics Submission
                    </span>
                ...
                <li className="nav-item ">
                  <Link
                    className="nav-link text-white "
                    to="/superAdmin/PublishNotification"
                  >
                    <span className="sidenav-normal  ms-2  ps-1">
